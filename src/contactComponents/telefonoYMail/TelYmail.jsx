  ...
  return (
    <div className='telYMail-body'>
      ...
      <div className='telYMail-container'>
        <div className='tel-card'><img src="src\assets\navBarimg\contactoIcon.jpg" alt="Phone Image"/>
        <h4>Tel: <a href="">+54 9 294 4212992</a></h4>
        <h4>Servicio al cliente: <a href="">0800 999 2225</a></h4> 
        </div>
        <div className='email-card'><img src="src\assets\navBarimg\contactoIcon.jpg" alt="Email Image"/>
